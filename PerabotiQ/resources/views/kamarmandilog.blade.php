...
<body class="product-details-page">
 ...
 <main class="main pt-5">
    ...
    <div class="container mb-4">
      <h2 class="fw-bold">Kamar Mandi</h2>
    </div>
      ...
      <div class="row g-4">
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/dalton rak.jpg" class="card-img-top" alt="KASUR">
            <div class="card-body">
              <h6 class="fw-bold mb-1">DALTON RAK</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/rain kabinet.jpg" class="card-img-top" alt="SMEDSTORP">
            <div class="card-body">
              <h6 class="fw-bold mb-1">RAIN KABINET</h6>
              <p class="mb-1 text-muted">Rp.2.000.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/roonyset.jpg" class="card-img-top" alt="LANGARYD">
            <div class="card-body">
              <h6 class="fw-bold mb-1">ROONY SET</h6>
              <p class="mb-1 text-muted">Rp.15.000.000</p>
              <div class="text-warning">★★★★☆</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/jemuran handuk.jpg" class="card-img-top" alt="VIMLE">
            <div class="card-body">
              <h6 class="fw-bold mb-1">JEMURAN HANDUK</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/tirai.jpg" class="card-img-top" alt="TORNSBORG">
            <div class="card-body">
              <h6 class="fw-bold mb-1">TIRAI</h6>
              <p class="mb-1 text-muted">Rp.900.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/rakmandi.jpg" class="card-img-top" alt="LANDSKORNA">
            <div class="card-body">
              <h6 class="fw-bold mb-1">RAK</h6>
              <p class="mb-1 text-muted">Rp.950.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/galleriaset.jpg" class="card-img-top" alt="STOCKHOLM">
            <div class="card-body">
              <h6 class="fw-bold mb-1">GALLERIA SET</h6>
              <p class="mb-1 text-muted">Rp.20.000.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/howlyset.jpg" class="card-img-top" alt="LART">
            <div class="card-body">
              <h6 class="fw-bold mb-1">HOWLY SET</h6>
              <p class="mb-1 text-muted">Rp.25.000.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/TANNFORSEN.png" class="card-img-top" alt="TANNFORSEN">
            <div class="card-body">
              <h6 class="fw-bold mb-1">TANNFORSEN</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/ANGSJON.png" class="card-img-top" alt="ANGSJON">
            <div class="card-body">
              <h6 class="fw-bold mb-1">ANGSJON</h6>
              <p class="mb-1 text-muted">Rp.2.500.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/GLYPEN.png" class="card-img-top" alt="GLYPEN">
            <div class="card-body">
              <h6 class="fw-bold mb-1">GLYPEN</h6>
              <p class="mb-1 text-muted">Rp.200.000</p>
              <div class="text-warning">★★★★☆</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/HAVBACK.png" class="card-img-top" alt="HAVBACK">
            <div class="card-body">
              <h6 class="fw-bold mb-1">HAVBACK</h6>
              <p class="mb-1 text-muted">Rp.2.800.000</p>
              <div class="text-warning">★★★★☆</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/TVALLEN.png" class="card-img-top" alt="TVALLEN">
            <div class="card-body">
              <h6 class="fw-bold mb-1">TVALLEN</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/VALLAMOSSE.png" class="card-img-top" alt="VALLAMOSSE">
            <div class="card-body">
              <h6 class="fw-bold mb-1">VALLAMOSSE</h6>
              <p class="mb-1 text-muted">Rp.500.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/OPPEJEN.png" class="card-img-top" alt="OPPEJEN">
            <div class="card-body">
              <h6 class="fw-bold mb-1">OPPEJEN</h6>
              <p class="mb-1 text-muted">Rp.1.100.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/BROGRUND.png" class="card-img-top" alt="BROGRUND">
            <div class="card-body">
              <h6 class="fw-bold mb-1">BROGRUND</h6>
              <p class="mb-1 text-muted">Rp.800.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
