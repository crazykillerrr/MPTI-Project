...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .sidebar { width:230px; background:#fff; border-right:1px solid #e8e5e0; padding:30px 0; flex-shrink:0; }
...
<body>
    <div class="sidebar">
        <div class="brand">PerabotiQ Admin</div>
        <nav>
            <a href="{{ route('admin.dashboard') }}" class="{{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">Dashboard</a>
            <a href="{{ route('admin.produk') }}"    class="{{ request()->routeIs('admin.produk*') ? 'active' : '' }}">Produk</a>
            <a href="{{ route('admin.pesanan') }}"   class="{{ request()->routeIs('admin.pesanan*') ? 'active' : '' }}">Pesanan</a>
