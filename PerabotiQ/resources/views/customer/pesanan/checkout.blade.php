...
@section('content')
        ...
        <div style="display:grid;grid-template-columns:1fr 380px;gap:24px;align-items:start;">
            ...
            <div>
                ...
                <div style="background:#fff;border:1px solid #e8e5e0;border-radius:14px;padding:24px;margin-bottom:20px;">
                    <div style="display:flex;align-items:flex-start;gap:14px;">
                        <div
                            style="width:38px;height:38px;background:#e8f5e9;border-radius:50%;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                        ...
                        <div>
                            ...
                            @if($user->phone)
                                <p style="font-size:0.84rem;color:#666;margin:0 0 2px;">(+62) {{ ltrim($user->phone, '+62') }}
                                </p>
                            @endif
                            ...
                            <span
                                style="display:inline-block;margin-top:6px;font-size:0.72rem;padding:2px 10px;background:#e8f5e9;color:#2e7d32;border-radius:20px;font-weight:600;">Rumah</span>
                        </div>
                    </div>
                </div>
                ...
                <div style="background:#fff;border:1px solid #e8e5e0;border-radius:14px;padding:24px;margin-bottom:20px;">
                    ...
                    @foreach($items as $item)
                        <div style="display:flex;align-items:center;gap:14px;padding:12px 0;border-bottom:1px solid #f0eeeb;">
                            <img src="{{ asset($item->produk->image) }}" alt="{{ $item->produk->nama }}"
                            ...
                            <div style="flex:1;">
                                <p style="font-weight:600;font-size:0.9rem;margin:0 0 4px;color:#1a1a1a;">
                                    {{ $item->produk->nama }}</p>
                ...
                <div style="background:#fff;border:1px solid #e8e5e0;border-radius:14px;padding:24px;margin-bottom:20px;">
                    ...
                    <label
                        style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px;border:2px solid #2e7d32;border-radius:10px;cursor:pointer;background:#f1f8e9;margin-bottom:10px;">
                        <div style="display:flex;align-items:center;gap:12px;">
                            <input type="radio" name="pengiriman" value="reguler" checked
                                style="accent-color:#2e7d32;width:16px;height:16px;"
                                onchange="updateShipping(this, 100000)">
                            <div>
                                <p style="font-weight:600;font-size:0.88rem;margin:0 0 2px;color:#1a1a1a;">PBQ Express
                                    (Regular)</p>
                        ...
                        <div style="display:flex;align-items:center;gap:10px;">
                            ...
                            <svg width="28" height="20" fill="#2e7d32" viewBox="0 0 24 24">
                                <path
                    ...
                    <label
                        style="display:flex;align-items:center;justify-content:space-between;padding:14px 16px;border:1px solid #e8e5e0;border-radius:10px;cursor:pointer;background:#fff;">
                        <div style="display:flex;align-items:center;gap:12px;">
                            <input type="radio" name="pengiriman" value="express"
                                style="accent-color:#2e7d32;width:16px;height:16px;"
                                onchange="updateShipping(this, 150000)">
                            <div>
                                <p style="font-weight:600;font-size:0.88rem;margin:0 0 2px;color:#1a1a1a;">PBQ Express (Next
                                    Day)</p>
                        ...
                        <div style="display:flex;align-items:center;gap:10px;">
                            ...
                            <svg width="28" height="20" fill="#999" viewBox="0 0 24 24">
                                <path
                                    d="M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2c0 1.66 1.34 3 3 3s3-1.34 3-3h6c0 1.66 1.34 3 3 3s3-1.34 3-3h2v-5l-3-4zM6 18.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm13.5-9l1.96 2.5H17V9.5h2.5zm-1.5 9c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z" />
                            </svg>
                        </div>
                ...
                <div style="background:#fff;border:1px solid #e8e5e0;border-radius:14px;padding:24px;">
                    ...
                    {{-- Transfer Bank --}}
                    <label id="lbl-transfer"
                        style="display:flex;align-items:center;gap:14px;padding:14px 16px;border:2px solid #2e7d32;border-radius:10px;cursor:pointer;background:#f1f8e9;margin-bottom:10px;transition:all 0.2s;">
                        ...
                        <div style="display:flex;align-items:center;gap:10px;flex:1;">
                            <div
                                style="width:36px;height:36px;background:#1565c0;border-radius:8px;display:flex;align-items:center;justify-content:center;">
                                <svg width="20" height="20" fill="#fff" viewBox="0 0 24 24">
                                    <path d="M4 10h12v2H4zm0 4h8v2H4zm11 4h2v-2h2v-2h-2v-2h-2v2h-2v2h2z" />
                                    <path d="M2 6h20v2H2zm0 14V8H2v12h20v-2H4v-2H2z" />
                                </svg>
                            </div>
                            <div>
                    ...
                    {{-- QRIS --}}
                    <label id="lbl-qris"
                        style="display:flex;align-items:center;gap:14px;padding:14px 16px;border:1px solid #e8e5e0;border-radius:10px;cursor:pointer;background:#fff;margin-bottom:10px;transition:all 0.2s;">
                        <input type="radio" name="metode_pembayaran_ui" value="qris"
                            style="accent-color:#2e7d32;width:16px;height:16px;" onchange="togglePayment(this)">
                        <div style="display:flex;align-items:center;gap:10px;flex:1;">
                            <div
                                style="width:36px;height:36px;background:#e91e63;border-radius:8px;display:flex;align-items:center;justify-content:center;">
                                <svg width="20" height="20" fill="#fff" viewBox="0 0 24 24">
                                    <path
                                        d="M3 3h7v7H3zm2 2v3h3V5zm9-2h7v7h-7zm2 2v3h3V5zM3 14h7v7H3zm2 2v3h3v-3zm11 1h2v2h-2zm-2-2h2v2h-2zm4 0h2v2h-2zm-4 4h2v2h-2zm2-2h2v2h-2zm2 2h2v2h-2z" />
                                </svg>
                            </div>
                            <div>
                    ...
                    {{-- COD --}}
                    <label id="lbl-cod"
                        style="display:flex;align-items:center;gap:14px;padding:14px 16px;border:1px solid #e8e5e0;border-radius:10px;cursor:pointer;background:#fff;transition:all 0.2s;">
                        <input type="radio" name="metode_pembayaran_ui" value="cod"
                            style="accent-color:#2e7d32;width:16px;height:16px;" onchange="togglePayment(this)">
                        <div style="display:flex;align-items:center;gap:10px;flex:1;">
                            <div
                                style="width:36px;height:36px;background:#f57f17;border-radius:8px;display:flex;align-items:center;justify-content:center;">
                                <svg width="20" height="20" fill="#fff" viewBox="0 0 24 24">
                                    <path
                            ...
                            <div>
                                <p style="font-weight:600;font-size:0.88rem;margin:0;color:#1a1a1a;">COD (Bayar di Tempat)
                                </p>
                    ...
                    <div id="bank-list" style="margin-top:14px;display:grid;grid-template-columns:repeat(3,1fr);gap:8px;">
                        @foreach(['Bank BRI Virtual Account', 'Bank BCA Virtual Account', 'Bank Mandiri Virtual Account', 'Bank BNI Virtual Account', 'Bank Permata (BRImo)', 'Bank Rakyat Indo (BRI)', 'Bank Tabungan Negara (BTN)'] as $bank)
                            <label
                                style="display:flex;align-items:center;gap:8px;padding:10px 12px;border:1px solid #e8e5e0;border-radius:8px;cursor:pointer;font-size:0.78rem;background:#fafaf9;">
            ...
            <div style="position:sticky;top:80px;">
                <form action="{{ route('checkout.konfirmasi') }}" method="POST"
                    ...
                    <div
                        style="display:flex;justify-content:space-between;font-size:0.84rem;color:#666;margin-bottom:16px;">
                        <span>Ongkos Kirim</span>
                        <span id="summary-ongkir">Rp.100.000</span>
                    </div>
                    ...
                    <div style="background:#f9f8f6;border-radius:10px;padding:14px;margin-bottom:18px;">
                        <div style="display:flex;justify-content:space-between;align-items:center;">
                            ...
                            <span id="summary-total"
                                style="font-weight:700;font-size:1.1rem;color:#2e7d32;">Rp.{{ number_format($grandTotal, 0, ',', '.') }}</span>
                        </div>
                    ...
                    <div style="margin-bottom:14px;">
                        <label
                            style="display:flex;align-items:flex-start;gap:10px;font-size:0.8rem;color:#666;cursor:pointer;">
                    ...
                    <button type="submit"
                        ...
                        <span id="btn-total-text">Bayar Rp.{{ number_format($grandTotal, 0, ',', '.') }}</span>
                    </button>
                </form>
            </div>
        </div>
    ...
    @push('scripts')
        <script>
            ...
            function updateShipping(radio, cost) {
                // Reset all shipping labels styles
                const labels = document.querySelectorAll('input[name="pengiriman"]');
                labels.forEach(input => {
                    const lbl = input.closest('label');
                    if (lbl) {
                        lbl.style.border = '1px solid #e8e5e0';
                        lbl.style.background = '#fff';
                    }
                });
                // Highlight selected
                const selectedLbl = radio.closest('label');
                if (selectedLbl) {
                    selectedLbl.style.border = '2px solid #2e7d32';
                    selectedLbl.style.background = '#f1f8e9';
                }
                ...
                document.getElementById('summary-ongkir').innerText = formatRp(cost);
                document.getElementById('summary-total').innerText = formatRp(grandTotal);
                document.getElementById('btn-total-text').innerText = 'Bayar ' + formatRp(grandTotal);
            }
        </script>
    @endpush
