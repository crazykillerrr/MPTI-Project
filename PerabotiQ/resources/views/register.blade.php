...
<head>
  ...
  <title>PerabotiQ - Register</title>
...
<body class="product-details-page">
  ...
  <main class="main">
    ...
    <main class="main">
        <section class="register-page d-flex align-items-center justify-content-center" style="min-height: 100vh; background-color: #f7eaea;">
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                  <h2 class="text-center fw-bold mb-4" style="font-family: 'Poppins', sans-serif;">Create Account</h2>
                  <form action="/register" method="POST" class="p-3">
                    ...
                    <div class="row g-3">
                      <div class="col-md-6">
                        ...
                        <input type="text" name="first_name" class="form-control input-custom" id="first name" required>
                      </div>
                      <div class="col-md-6">
                        <label for="last name" class="form-label">Last name</label>
                        <input type="text" name="last_name" class="form-control input-custom" id="last name">
                      </div>
                      <div class="col-md-6">
                        <label for="address" class="form-label">Address</label>
                        <input type="text" name="address" class="form-control input-custom" id="address">
                      </div>
                      <div class="col-md-6">
                        <label for="post code" class="form-label">Post Code</label>
                        <input type="text" name="post_code" class="form-control input-custom" id="post code">
                      </div>
                      <div class="col-md-6">
                        <label for="email" class="form-label">E-mail</label>
                        <input type="email" name="email" class="form-control input-custom" id="email" required>
                      </div>
                      <div class="col-md-6">
                        <label for="password" class="form-label">Password</label>
                        <input type="password" name="password" class="form-control input-custom" id="password" required>
                      </div>
                      <div class="col-md-3">
                        <label for="phone number" class="form-label">Phone Number</label>
                        <select class="form-select input-custom" name="country_code">
                      ...
                      <div class="col-md-9">
                        ...
                        <input type="text" name="cell_number" class="form-control input-custom" id="cell number">
                      </div>
