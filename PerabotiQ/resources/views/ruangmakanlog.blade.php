...
<body class="product-details-page">
 ...
 <main class="main pt-5">
    ...
    <div class="container mb-4">
      <h2 class="fw-bold">Ruang Makan</h2>
    </div>
      ...
      <div class="row g-4">
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/ADDE.png" class="card-img-top" alt="ADDE">
            <div class="card-body">
              <h6 class="fw-bold mb-1">ADDE</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/KILSVIKEN.png" class="card-img-top" alt="KILSVIKEN">
            <div class="card-body">
              <h6 class="fw-bold mb-1">KILSVIKEN</h6>
              <p class="mb-1 text-muted">Rp.2.900.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/BERGMUND.png" class="card-img-top" alt="BERGMUND">
            <div class="card-body">
              <h6 class="fw-bold mb-1">BERGMUND</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/KNOXHULT.png" class="card-img-top" alt="KNOXHULT">
            <div class="card-body">
              <h6 class="fw-bold mb-1">KNOXHULT</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/LISABO.png" class="card-img-top" alt="LISABO">
            <div class="card-body">
              <h6 class="fw-bold mb-1">LISABO</h6>
              <p class="mb-1 text-muted">Rp.4.500.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/PINNTORP.png" class="card-img-top" alt="PINNTORP">
            <div class="card-body">
              <h6 class="fw-bold mb-1">PINNTORP</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/EKEDALEN.png" class="card-img-top" alt="EKEDALEN">
            <div class="card-body">
              <h6 class="fw-bold mb-1">EKEDALEN</h6>
              <p class="mb-1 text-muted">Rp.4.200.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/dutton set.jpg" class="card-img-top" alt="LART">
            <div class="card-body">
              <h6 class="fw-bold mb-1">DUTTON SET</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/lisabo.jpg" class="card-img-top" alt="KASUR">
            <div class="card-body">
              <h6 class="fw-bold mb-1">LISABO</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/NORDEN.png" class="card-img-top" alt="NORDEN">
            <div class="card-body">
              <h6 class="fw-bold mb-1">NORDEN</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/sendok.jpg" class="card-img-top" alt="LANGARYD">
            <div class="card-body">
              <h6 class="fw-bold mb-1">SENDOK</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/korken.jpg" class="card-img-top" alt="VIMLE">
            <div class="card-body">
              <h6 class="fw-bold mb-1">KORKEN</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/fargklar.jpg" class="card-img-top" alt="TORNSBORG">
            <div class="card-body">
              <h6 class="fw-bold mb-1">FARGKLAR</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/godis.jpg" class="card-img-top" alt="LANDSKORNA">
            <div class="card-body">
              <h6 class="fw-bold mb-1">GODIS</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/gunde.jpg" class="card-img-top" alt="STOCKHOLM">
            <div class="card-body">
              <h6 class="fw-bold mb-1">GUNDE</h6>
              <p class="mb-1 text-muted">Rp.3.500.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/FROJDA.png" class="card-img-top" alt="FROJDA">
            <div class="card-body">
              <h6 class="fw-bold mb-1">FROJDA</h6>
              <p class="mb-1 text-muted">Rp.1.500.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
