...
<body class="product-details-page">
  ...
  <main class="main">
    ...
    <main class="main">
        <section class="login-page d-flex w-100">
            <!-- Left Panel -->
            <div class="login-left flex-fill d-none d-md-block"></div>
      
            <!-- Right Panel -->
            <div class="login-right flex-fill d-flex align-items-center justify-content-center">
              <div class="login-form-container p-4 p-md-5">
                <h2 class="text-center fw-bold mb-4" style="font-family: 'Poppins', sans-serif;">Hey, Welcome Back</h2>
                <p class="mb-4">Sign in into your account</p>
                <form action="/login" method="POST">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input type="email" name="email" class="form-control input-custom" id="email" required value="{{ old('email') }}">
                  </div>
                  ...
                  <div class="mb-4">
                    <a href="#" class="text-decoration-none small text-forgot">forgot password?</a>
                  </div>
                  <div class="d-grid mb-2">
                    <button type="submit" class="btn btn-login fw-bold">Sign In</button>
                  </div>
                  <div class="text-center mb-2">or</div>
                  <div class="d-grid">
                    <a href="/register" class="btn btn-create fw-bold">Create Account</a>
                  </div>
                </form>
              </div>
            </div>
