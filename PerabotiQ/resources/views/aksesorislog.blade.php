      ...
      <div class="row g-4">
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/lamp.jpg" class="card-img-top" alt="Lamp">
            <div class="card-body">
              <h6 class="fw-bold mb-1">LAMP</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/sapu.jpg" class="card-img-top" alt="SAPU">
            <div class="card-body">
              <h6 class="fw-bold mb-1">SAPU</h6>
              <p class="mb-1 text-muted">Rp.150.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/toples.jpg" class="card-img-top" alt="TOPLES">
            <div class="card-body">
              <h6 class="fw-bold mb-1">TOPLES</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/sapukecil.jpg" class="card-img-top" alt="SAPU KECIL">
            <div class="card-body">
              <h6 class="fw-bold mb-1">SAPU KECIL</h6>
              <p class="mb-1 text-muted">Rp.70.000</p>
              <div class="text-warning">★★★★☆</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/sabun.jpg" class="card-img-top" alt="SABUN">
            <div class="card-body">
              <h6 class="fw-bold mb-1">SABUN</h6>
              <p class="mb-1 text-muted">Rp.200.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/boxmainan.jpg" class="card-img-top" alt="BOX MAINAN">
            <div class="card-body">
              <h6 class="fw-bold mb-1">BOX MAINAN</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/tempat sampah.png" class="card-img-top" alt="WASTE BIN">
            <div class="card-body">
              <h6 class="fw-bold mb-1">WASTE BIN</h6>
              <p class="mb-1 text-muted">Rp.100.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/tempat sabun.png" class="card-img-top" alt="tempat sabun">
            <div class="card-body">
              <h6 class="fw-bold mb-1">SOAP DISPENSER</h6>
              <p class="mb-1 text-muted">Rp.30.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card shadow-sm product-card">
                <img src="assets/img/BATHMAT.png" class="card-img-top" alt="BATHMAT">
                <div class="card-body">
                  <h6 class="fw-bold mb-1">BATH MAT</h6>
                  <p class="mb-1 text-muted">Rp.70.000</p>
                  <div class="text-warning">★★★★★</div>
                </div>
              </div>
            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card shadow-sm product-card">
                <img src="assets/img/RESEALABLE BAG.png" class="card-img-top" alt="RESEALABLE">
                <div class="card-body">
                  <h6 class="fw-bold mb-1">RESEALABLE BAG</h6>
                  <p class="mb-1 text-muted">Rp.35.000</p>
                  <div class="text-warning">★★★★★</div>
                </div>
              </div>
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card shadow-sm product-card">
                <img src="assets/img/LAUNDRY BASKET.png" class="card-img-top" alt="LAUNDRY BASKET ">
                <div class="card-body">
                  <h6 class="fw-bold mb-1">LAUNDRY BASKET</h6>
                  <p class="mb-1 text-muted">Rp.75.000</p>
                  <div class="text-warning">★★★★☆</div>
                </div>
              </div>
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card shadow-sm product-card">
                <img src="assets/img/BUCKET SET.png" class="card-img-top" alt="BUCKET">
                <div class="card-body">
                  <h6 class="fw-bold mb-1">BUCKET SET</h6>
                  <p class="mb-1 text-muted">Rp.80.000</p>
                  <div class="text-warning">★★★★★</div>
                </div>
              </div>
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card shadow-sm product-card">
                <img src="assets/img/WASHTUB.png" class="card-img-top" alt="WASHTUB">
                <div class="card-body">
                  <h6 class="fw-bold mb-1">WASH TUB</h6>
                  <p class="mb-1 text-muted">Rp.85.000</p>
                  <div class="text-warning">★★★★★</div>
                </div>
              </div>
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card shadow-sm product-card">
                <img src="assets/img/CLINNINGGLOVES.png" class="card-img-top" alt="CLINNINGGLOVES">
                <div class="card-body">
                  <h6 class="fw-bold mb-1">CLINNING GLOVES</h6>
                  <p class="mb-1 text-muted">Rp.100.000</p>
                  <div class="text-warning">★★★★★</div>
                </div>
              </div>
            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card shadow-sm product-card">
                <img src="assets/img/HANGER.png" class="card-img-top" alt="HANGER ">
                <div class="card-body">
                  <h6 class="fw-bold mb-1">HANGER</h6>
                  <p class="mb-1 text-muted">Rp.75.000</p>
                  <div class="text-warning">★★★★★</div>
                </div>
              </div>
