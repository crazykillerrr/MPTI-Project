...
<body class="product-details-page">
 ...
 <main class="main pt-5">
    ...
    <div class="container mb-4">
      <h2 class="fw-bold">Ruang Tidur</h2>
    </div>
      ...
      <div class="row g-4">
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/Kasur.png" class="card-img-top" alt= "KASUR">
            <div class="card-body">
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/lemari.jpg" class="card-img-top" alt="LEMARI">
            <div class="card-body">
              <h6 class="fw-bold mb-1">LEMARI</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/kaca.jpg" class="card-img-top" alt="KACA">
            <div class="card-body">
              <h6 class="fw-bold mb-1">KACA</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/jam.jpg" class="card-img-top" alt="JAM">
            <div class="card-body">
              <h6 class="fw-bold mb-1">JAM DINDING</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/rakbuku.jpg" class="card-img-top" alt="RAK BUKU">
            <div class="card-body">
              <h6 class="fw-bold mb-1">RAK BUKU</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/lampu tidur.jpg" class="card-img-top" alt="LAMPU TIDUR">
            <div class="card-body">
              <h6 class="fw-bold mb-1">LAMPU TIDUR</h6>
              <p class="mb-1 text-muted">Rp.400.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/meja.jpg" class="card-img-top" alt="MEJA">
            <div class="card-body">
              <h6 class="fw-bold mb-1">MEJA BELAJAR</h6>
              <p class="mb-1 text-muted">Rp.3.500.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/mejarias.jpg" class="card-img-top" alt="MEJA RIAS">
            <div class="card-body">
              <h6 class="fw-bold mb-1">MEJA RIAS</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/HAUGA.png" class="card-img-top" alt="HAUGA">
            <div class="card-body">
              <h6 class="fw-bold mb-1">HAUGA</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/NORDLI.png" class="card-img-top" alt="NORDLI">
            <div class="card-body">
              <h6 class="fw-bold mb-1">NORDLI</h6>
              <p class="mb-1 text-muted">Rp.2.500.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/MALM.png" class="card-img-top" alt="MALM">
            <div class="card-body">
              <h6 class="fw-bold mb-1">MALM</h6>
              <p class="mb-1 text-muted">Rp.1.800.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/TARVA.png" class="card-img-top" alt="TARVA">
            <div class="card-body">
              <h6 class="fw-bold mb-1">TARVA</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/ASKVOLL.png" class="card-img-top" alt="ASKVOLL">
            <div class="card-body">
              <h6 class="fw-bold mb-1">ASKVOLL</h6>
              <p class="mb-1 text-muted">Rp.3.400.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/VIKHAMMER.png" class="card-img-top" alt="VIKHAMMER">
            <div class="card-body">
              <h6 class="fw-bold mb-1">VIKHAMMER</h6>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/FONSTERBLAD.png" class="card-img-top" alt="FONSTERBLAD">
            <div class="card-body">
              <h6 class="fw-bold mb-1">FONSTERBLAD</h6>
              <p class="mb-1 text-muted">Rp.350.000</p>
              <div class="text-warning">★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card shadow-sm product-card">
            <img src="assets/img/VIHALS.png" class="card-img-top" alt="VIHALS">
            <div class="card-body">
              <h6 class="fw-bold mb-1">VIHALS</h6>
              <p class="mb-1 text-muted">Rp.2.800.000</p>
              <div class="text-warning">★★★★☆</div>
            </div>
          </div>
