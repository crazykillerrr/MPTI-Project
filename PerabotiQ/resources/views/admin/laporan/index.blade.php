...
<div class="page-header">
    <div>
        <h1><i class="bi bi-bar-chart-line-fill" style="color:var(--accent);margin-right:8px;"></i>Laporan Penjualan</h1>
        <p>Ringkasan pendapatan dan penjualan toko</p>
    </div>
</div>
...
<div style="background:var(--card-bg);border:1px solid var(--card-border);border-radius:var(--radius-lg);padding:28px;margin-bottom:28px;box-shadow:var(--shadow-sm);">
    <h3 style="font-size:0.95rem;font-weight:600;margin-bottom:20px;color:var(--text-secondary);">
        <i class="bi bi-graph-up" style="margin-right:6px;color:var(--accent);"></i>Grafik Pendapatan per Bulan
    </h3>
...
<h2 style="font-size:1rem;font-weight:600;margin:0 0 16px;color:var(--text-secondary);">
    <i class="bi bi-table" style="margin-right:6px;"></i>Rincian per Bulan
</h2>
<div class="table-container" style="max-width:520px;">
    <table>
        <thead><tr><th>Bulan</th><th style="text-align:right;">Pendapatan</th></tr></thead>
        <tbody>
