      ...
      <div id="hero-carousel" data-bs-interval="5000" class="container-fluid carousel carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-item active" style="background-image: url(https://www.pixelstalk.net/wp-content/uploads/images1/Free-furniture-wallpapers.jpg);">
          <div class="carousel-container">
            ...
            <p class="animate__animated animate__fadeInUp" style="color: white;">Furnish every room with quality</p>
          </div>
        </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="product-item position-relative p-0 overflow-hidden">
              <a href="{{ route('produk.kategori', 'ruang-tamu') }}">
           ...
           <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="product-item position-relative p-0 overflow-hidden">
              <a href="{{ route('produk.kategori', 'ruang-tidur') }}">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="product-item position-relative p-0 overflow-hidden">
              <a href="{{ route('produk.kategori', 'ruang-makan') }}">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="product-item position-relative p-0 overflow-hidden">
              <a href="{{ route('produk.kategori', 'kamar-mandi') }}">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="product-item position-relative p-0 overflow-hidden">
              <a href="{{ route('produk.kategori', 'aksesoris') }}">
